...
The app stores one small preference on-device (your last-used Edit /
Split / Preview layout) via the standard system preferences store. It
never leaves your device and contains no personal information.

## Permissions

md requests no special permissions — no camera, microphone, contacts,
location, or photo-library access. File access is mediated by the system
document picker / browser: you choose what the app can open, and on Mac
